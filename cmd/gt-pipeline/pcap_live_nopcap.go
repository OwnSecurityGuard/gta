...
var errNoPcap = errors.New("live capture unavailable: this binary was built without -tags pcap (cross-compiled release); use the Docker image or rebuild with `go build -tags pcap ./cmd/gt-pipeline`")
