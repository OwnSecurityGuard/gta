...
// Activate and Deactivate are explicitly deferred to P2 (build/activate
// closure). The embedded UnimplementedPluginDevServer already returns
// codes.Unimplemented for them, which is the correct behaviour until then.
